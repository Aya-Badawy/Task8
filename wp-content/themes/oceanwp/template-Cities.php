...
<header class="w3-container  w3-center" style="padding:128px 16px">
  <h1 class="w3-margin w3-jumbo">Cities</h1>
  <p class="w3-xlarge">All What You need To Know and More here </p>
  <a href="<?php echo get_site_url(); ?>">
  <button class="w3-button w3-yellow w3-padding-large w3-large w3-margin-top">
...
<div class="w3-row-padding  w3-blue w3-padding-64 w3-container">
  ...
  <div class="card-body">
    ...
    <a href='<?php the_shortlink() ?>' class="btn btn-primary">read more</a>
  </div>
</div>
  </div>
    <?php endwhile;?>
