...
/**
 * Check if promo box section is enabled.
 *
 * @since Mega Blog 1.0.0
 * @param WP_Customize_Control $control WP_Customize_Control instance.
 * @return bool Whether the control is active to the current preview.
 */
function mega_blog_is_promo_box_section_enable( $control ) {
	return ( $control->manager->get_setting( 'mega_blog_theme_options[promo_box_section_enable]' )->value() );
}
