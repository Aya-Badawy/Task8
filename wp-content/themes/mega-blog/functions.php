...
if ( ! function_exists( 'mega_blog_setup' ) ) :
	...
	function mega_blog_setup() {
		...
		add_theme_support( 'editor-color-palette', array(
	       	array(
	           	'name' => esc_html__( 'Yellow', 'mega-blog' ),
	           	'slug' => 'yellow',
	           	'color' => '#cea35f',
	       	),
	       	array(
	           	'name' => esc_html__( 'Black', 'mega-blog' ),
	           	'slug' => 'black',
	           	'color' => '#343b3d',
	       	),
	       	array(
	           	'name' => esc_html__( 'Grey', 'mega-blog' ),
	           	'slug' => 'grey',
	           	'color' => '#697275',
	       	),
	   	));
		...
		add_theme_support( 'editor-font-sizes', array(
		   	array(
		       	'name' => esc_html__( 'small', 'mega-blog' ),
		       	'shortName' => esc_html__( 'S', 'mega-blog' ),
		       	'size' => 12,
		       	'slug' => 'small'
		   	),
		   	array(
		       	'name' => esc_html__( 'regular', 'mega-blog' ),
		       	'shortName' => esc_html__( 'M', 'mega-blog' ),
		       	'size' => 16,
		       	'slug' => 'regular'
		   	),
		   	array(
		       	'name' => esc_html__( 'larger', 'mega-blog' ),
		       	'shortName' => esc_html__( 'L', 'mega-blog' ),
		       	'size' => 36,
		       	'slug' => 'larger'
		   	),
		   	array(
		       	'name' => esc_html__( 'huge', 'mega-blog' ),
		       	'shortName' => esc_html__( 'XL', 'mega-blog' ),
		       	'size' => 48,
		       	'slug' => 'huge'
		   	)
		));
...
function mega_blog_scripts() {
	...
	// blocks
	wp_enqueue_style( 'mega-blog-blocks', get_template_directory_uri() . '/assets/css/blocks' . mega_blog_min() . '.css' );
 ...
 */
function mega_blog_block_editor_styles() {
	// Block styles.
	wp_enqueue_style( 'mega-blog-block-editor-style', get_theme_file_uri( '/assets/css/editor-blocks' . mega_blog_min() . '.css' ) );
	// Add custom fonts.
	wp_enqueue_style( 'mega-blog-fonts', mega_blog_fonts_url(), array(), null );
}
add_action( 'enqueue_block_editor_assets', 'mega_blog_block_editor_styles' );
